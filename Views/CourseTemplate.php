...
class CourseTemplate extends BaseTemplate
{
    public static function renderCourse(int $courseId): string
    {
        ...
        if (!$course) {
            ...
            return '<div class="container py-5"><h1>Курс не найден</h1><a href="/courses">Вернуться к списку</a></div>';
        }

        $title = $course['title'] . ' — Кемеровский кооперативный техникум';
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 p-4 mt-4">
                        <h4 class="fw-bold mb-3">Детали обучения</h4>
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted">' . ($course['certificate'] ? 'Выдается' : 'Не выдается') . '</p>
                            </div>
                            <div class="col-md-6">
                                <strong>Трудоустройство:</strong>
                                <p class="text-muted">' . ($course['job_assistance'] ? 'Помощь предоставляется' : 'Не предоставляется') . '</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="cta-section">
                        <h4 class="fw-bold mb-3">Записаться на курс</h4>
                        <p class="text-muted mb-4">Оставьте заявку, и мы свяжемся с вами</p>
                        ...
                        <p class="small text-muted mt-4 mb-0">
                            ' . ($course['certificate'] ? '✓ Сертификат по окончании<br>' : '') . '
                            ' . ($course['job_assistance'] ? '✓ Помощь в трудоустройстве' : '') . '
                        </p>
                    </div>
                </div>
            </div>
