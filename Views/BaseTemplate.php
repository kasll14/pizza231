...
class BaseTemplate
{
    public static function getTemplate(): string
    {
        ...
        // 🔧 ФИКС: Безопасное получение имени пользователя (защита от null/неверного типа)
        $userName = '';
        $userInitial = '?';
        ...
        if ($currentUser !== null) {
            if (is_array($currentUser) && isset($currentUser['name'])) {
                ...
                // Fallback: берём имя из email, если name отсутствует
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <div class="user-menu">
                            ' . ($isLoggedIn ? '
                                <!-- 🔧 ФИКС: Использованы безопасные переменные $userInitial и $userName -->
                                <span class="user-avatar">' . $userInitial . '</span>
                                <a href="/profile" class="btn-profile">' . htmlspecialchars($userName) . '</a>
                                <!-- 🔧 КОНЕЦ ФИКСА -->
                                ' . ($isAdmin ? '<a href="/admin" class="btn-admin">' . $authAdmin . '</a>' : '') . '
                                <a href="/auth/logout" class="btn-logout">' . $authLogout . '</a>
                            ' : '
                                <a href="/auth/login" class="btn-login">' . $authLogin . '</a>
                                <a href="/auth/register" class="btn-register">' . $authRegister . '</a>
                            ') . '
                        </div>
                    </li>
                </ul>
