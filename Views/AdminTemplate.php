...
class AdminTemplate extends BaseTemplate
{
    ...
    public static function getOrderDetailTemplate(array $order): string
    {
                    ...
                    <div class="detail-section">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value"><a href="mailto:' . htmlspecialchars($order['email']) . '">' . htmlspecialchars($order['email']) . '</a></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">' . Language::get('checkout_phone') . '</div>
                                <div class="info-value"><a href="tel:' . htmlspecialchars($order['phone']) . '">' . htmlspecialchars($order['phone']) . '</a></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">IP</div>
                                <div class="info-value">' . htmlspecialchars($order['ip']) . '</div>
                            </div>
                        </div>
                    </div>
                    <div class="detail-section">
                    ...
                    <div class="detail-section">
                        ...
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <div class="info-value">' . htmlspecialchars($order['status']) . '</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">' . Language::get('admin_date') . '</div>
                                <div class="info-value">' . htmlspecialchars($order['created_at']) . '</div>
                            </div>
                        </div>
        ...
        if (!empty($order['comment'])) {
            $content .= '<div class="detail-section"><h3>' . Language::get('checkout_comment') . '</h3><div class="info-item"><p style="margin:0">' . htmlspecialchars($order['comment']) . '</p></div></div>';
        }
    ...
    // ✅ СПИСОК ПОЛЬЗОВАТЕЛЕЙ (НОВЫЙ МЕТОД)
