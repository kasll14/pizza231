...
<a href="/course/1" class="btn btn-custom">Подробнее →</a>
...
<a href="/course/2" class="btn btn-custom">Подробнее →</a>
<form method="POST" action="/cart/add" class="mt-2">
...
<a href="/course/3" class="btn btn-custom">Подробнее →</a>
<form method="POST" action="/cart/add" class="mt-2">
...
<a href="/course/4" class="btn btn-custom">Подробнее →</a>
<form method="POST" action="/cart/add" class="mt-2">
...
<a href="/course/5" class="btn btn-custom">Подробнее →</a>
<form method="POST" action="/cart/add" class="mt-2">
...
<a href="/course/6" class="btn btn-custom">Подробнее →</a>
<form method="POST" action="/cart/add" class="mt-2">
