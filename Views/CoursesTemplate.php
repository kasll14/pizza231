...
class CoursesTemplate extends BaseTemplate
{
    public static function getTemplate(): string
    {
        ...
        $title = 'Курсы — Кемеровский кооперативный техникум';
        ...
        foreach ($courses as $course) {
            ...
            <a href="/course/' . $course['id'] . '" class="course-card">
                ...
                <div class="d-flex gap-2 mt-auto">
                    <span class="btn-card btn-outline" style="flex:1">Подробнее</span>
                    <form method="POST" action="/cart/add" style="flex:1" onclick="event.stopPropagation()">
                        <input type="hidden" name="courseId" value="' . $course['id'] . '">
                        <button type="submit" class="btn-card btn-primary" style="width:100%">В корзину</button>
                    </form>
                </div>
            </a>';
        }
        ...
        <section class="container py-5">
            <div class="page-header">
                ...
                <p class="page-subtitle">Выберите направление и начните освоение профессии</p>
            </div>
