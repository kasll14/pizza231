...
define('BG_IMAGE_BLUR', 8);           // Размытие в пикселях (0-20)
define('BG_IMAGE_OVERLAY_COLOR', '255, 255, 255'); // RGB цвет оверлея
define('BG_IMAGE_OVERLAY_OPACITY', 0.3); // Прозрачность оверлея (0-1)
define('BG_IMAGE_SCALE', 1.1);        // Масштаб изображения (для компенсации размытия)
...
define('GLASS_CONTOUR_WIDTH', 8);      // Ширина стеклянного контура в px (8px)
...
define('GLASS_INNER_OPACITY', 0.5);   // Прозрачность внутреннего фона (0-1)
define('GLASS_SHADOW_COLOR', '0, 0, 0'); // RGB цвет тени
define('GLASS_SHADOW_OPACITY', 0.12);  // Прозрачность тени (0-1)
define('GLASS_RADIUS', 20);            // Радиус скругления (px)
?>
